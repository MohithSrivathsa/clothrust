...
pub fn seed_products(conn: &Connection) -> Result<()> {
    ...
    let products = vec![
        ...
        ("Mandala Spirit Shirt","Intricate mandala print. Each piece is individually heat-pressed.",1199.0,"Shirts",r#"["XS","S","M","L","XL"]"#,r#"["White","Navy","Burgundy"]"#,"/static/images/shirt1.svg",None),
        ...
        ("Botanical Print Tee","Delicate botanical illustration print. Soft-washed fabric.",849.0,"T-Shirts",r#"["XS","S","M","L","XL"]"#,r#"["White","Peach","Mint"]"#,"/static/images/tee3.svg",None),
